...
/*
 ...
 MyFonts Webfont Build ID 3657200, 2018-10-18T00:53:36-0400
 ...
 License: https://www.myfonts.com/viewlicense?type=web&buildid=3657200
...
for(var fonts=[{fontFamily:"SkyhookMono",url:wfpath+"37CDF0_0"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+";");css+=
